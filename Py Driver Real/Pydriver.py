...
#partial code contribution by Professor David Johnson at the University of Utah
...
def main():
    ...
    while is_alive:
        ...
        # sets the transparency and the stage, after getting the unscrambler, everything becomes functional and the map changes
        if third_level == True:
            start_screen_click = False
            screen.fill((0, 0, 0))
            screen.blit(player, player_rect)
